...
Source: `https://durablestreams.com/clients.md`
...
| --- | --- | --- |
| [TypeScript](typescript-client.md) | `npm install @durable-streams/client` | Production-Proven |
| [Python](python-client.md) | `pip install durable-streams` | Expert-Reviewed |
| [Go](https://durablestreams.com/clients.md#go) | `go get github.com/durable-streams/durable-streams/packages/client-go` | Expert-Reviewed |
| [Elixir](https://durablestreams.com/clients.md#elixir) | Add `{:durable_streams, "~> 0.1.0"}` to `mix.exs` | Vibe-Engineered |
| [C# / .NET](https://durablestreams.com/clients.md#c--net) | `dotnet add package DurableStreams` | Vibe-Engineered |
| [Swift](https://durablestreams.com/clients.md#swift) | Swift Package Manager (`DurableStreams`) | Vibe-Engineered |
| [PHP](https://durablestreams.com/clients.md#php) | `composer require durable-streams/client` | Vibe-Engineered |
| [Java](https://durablestreams.com/clients.md#java) | Maven / Gradle (`durable-streams`) | Vibe-Engineered |
| [Rust](https://durablestreams.com/clients.md#rust) | `cargo add durable-streams` | Vibe-Engineered |
| [Ruby](https://durablestreams.com/clients.md#ruby) | `gem install durable_streams` | Vibe-Engineered |
...
- `IAsyncEnumerable` support for natural `await foreach` consumption
...
- Type-safe `JsonIterator` with pluggable JSON parsers (Gson, Jackson, etc.)
