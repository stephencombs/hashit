...
Source: `https://durablestreams.com/deployment.md`

[Self-host with Caddy](https://durablestreams.com/deployment.md#self-hosted-with-caddy) or run in production using [Electric Cloud](https://dashboard.electric-sql.cloud/).
...
| --- | --- | --- |
| `data_dir` | (none -- in-memory) | Path to persistent storage directory (LMDB) |
