...
Source: `https://durablestreams.com/tanstack-ai.md`

[TanStack AI](https://tanstack.com/ai) is a type-safe, framework agnostic AI SDK.

It provides a unified interface across multiple LLM providers. With no vendor lock-in and no proprietary formats -- just clean TypeScript and honest open source.
...
Then, because any client connecting to the same session subscribes and writes to the same Durable Stream, this naturally works across tabs, devices, users and agents. Both in real-time and asynchronously -- clients can read, join and fork the session at any time.
...
As a result, the design of the Durable Streams TanStack AI integration follows the principle of inversion of control. Rather than prescribing how to handle message history, the integration puts you in control of how you handle persistence and retrival.
