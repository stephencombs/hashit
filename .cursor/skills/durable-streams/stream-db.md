...
Source: `https://durablestreams.com/stream-db.md`

StreamDB is a type-safe reactive database in a durable stream.

Pass in a [StandardSchema](https://durablestreams.com/stream-db.md#define-a-standardschema) and get typed collections, reactive queries, and optimistic actions on top of [Durable State](durable-state.md).
