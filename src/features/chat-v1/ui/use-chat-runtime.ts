...
import {
  ...
  setThreadTitle,
} from "~/features/chat-v1/ui/thread-list-cache";
import {
  clearThreadStreaming,
  markThreadStreaming,
} from "~/features/chat-v1/ui/thread-streaming-db";
import {
  isLocalOrPrivateAttachmentUrl,
  toAbsoluteAttachmentUrl,
  uploadAttachmentSource,
} from "~/features/chat-v1/ui/chat-session-attachments";
import { getPendingInteractiveTarget } from "~/features/chat-v1/ui/chat-session-interactive";
import type {
  ChatMessageShape,
  UseChatControllerOptions,
} from "~/features/chat-v1/ui/chat-session-types";
import { useMcpSettings } from "~/shared/hooks/use-mcp-settings";
import { useModelSettings } from "~/shared/hooks/use-model-settings";
import { LiveSpecStore } from "~/shared/lib/live-spec-store";
import {
