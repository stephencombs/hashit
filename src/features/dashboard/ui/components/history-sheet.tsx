...
import type { dashboardSnapshotWireSchema } from "~/features/dashboard/contracts/dashboard-schemas";
...
import {
  ...
  type RecipeStatus,
} from "~/features/dashboard/ui/components/generation-progress-views";
import {
  KindIcon,
  StatusDot,
  StatTile,
} from "~/features/dashboard/ui/components/generation-shared";
import {
  useBuildEvents,
  type BuildEvent,
} from "~/features/dashboard/data/dashboard-build-events";
import type {
  PersistedRecipe,
  PersistedWidget,
