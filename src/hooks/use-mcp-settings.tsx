...
export function McpSettingsProvider({
  ...
  const value = useMemo(
    ...
    [selectedServers, enabledTools, toggleServer, toggleTool, toggleAllTools, reset],
  )

  return (
    <McpSettingsContext value={value}>{children}</McpSettingsContext>
  )
}
