...
function renderDeferredVisualization(
  ...
  return (
    <Suspense fallback={<LoadingMessage>Loading visualization...</LoadingMessage>}>
  ...
  components: {
    AreaChart: ({ props }) => {
      ...
      return renderDeferredVisualization(
        LazyAreaChartRenderer as unknown as LazyExoticComponent<(props: DeferredRendererProps) => ReactNode>,
    ...
    BarChart: ({ props }) => {
      const fill = useFillMode()
      return renderDeferredVisualization(
        LazyBarChartRenderer as unknown as LazyExoticComponent<(props: DeferredRendererProps) => ReactNode>,
        props as Record<string, unknown>,
        fill,
      )
    },
    ...
    LineChart: ({ props }) => {
      const fill = useFillMode()
      return renderDeferredVisualization(
        LazyLineChartRenderer as unknown as LazyExoticComponent<(props: DeferredRendererProps) => ReactNode>,
        props as Record<string, unknown>,
        fill,
      )
    },
    ...
    PieChart: ({ props }) => {
      const fill = useFillMode()
      return renderDeferredVisualization(
        LazyPieChartRenderer as unknown as LazyExoticComponent<(props: DeferredRendererProps) => ReactNode>,
        props as Record<string, unknown>,
        fill,
      )
    },
    ...
    RadarChart: ({ props }) => {
      const fill = useFillMode()
      return renderDeferredVisualization(
        LazyRadarChartRenderer as unknown as LazyExoticComponent<(props: DeferredRendererProps) => ReactNode>,
        props as Record<string, unknown>,
        fill,
      )
    },
    ...
    RadialChart: ({ props }) => {
      const fill = useFillMode()
      return renderDeferredVisualization(
        LazyRadialChartRenderer as unknown as LazyExoticComponent<(props: DeferredRendererProps) => ReactNode>,
        props as Record<string, unknown>,
        fill,
      )
    },
    ...
    DataGrid: ({ props }) => {
      const fill = useFillMode()
      return renderDeferredVisualization(
        LazyDataGridRenderer as unknown as LazyExoticComponent<(props: DeferredRendererProps) => ReactNode>,
        props as Record<string, unknown>,
        fill,
      )
    },
